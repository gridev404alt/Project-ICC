    ...
    return (
        <footer className="mx-auto max-w-7xl px-6 pb-10">
            <div className="grid grid-cols-1 gap-10 border-t border-border pt-10 md:grid-cols-3">
                <div>
                    <h4 className="text-base font-semibold text-foreground">Indonesia Coffee Center</h4>
            ...
            <p className="mt-10 text-center text-xs text-muted-foreground">@2026 Indonesia Coffee Center (ICC)</p>
        </footer>
    );
}
